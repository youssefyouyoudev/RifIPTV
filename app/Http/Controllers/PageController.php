...
class PageController extends Controller
{
    ...
    protected function packagesPage(): array
    {
        return $this->localized([
            'en' => [
                'meta_title' => 'Plans and packs | Rifi Media',
                'meta_description' => 'Compare Smart TV packs and the SUP plan with clear prices, guided setup, app help, and follow-up support in Morocco.',
                'kicker' => 'Plans and packs',
                'headline' => 'Choose the plan or Smart TV pack that fits your setup needs.',
                'description' => 'Smart TV packs are available in 3, 6, and 12 months, while SUP stays available as a separate 12-month plan.',
            ],
            'fr' => [
                'meta_title' => 'Plans et packs | Rifi Media',
                'meta_description' => 'Comparez les packs Smart TV et le plan SUP avec des prix clairs, une installation guidee et un suivi au Maroc.',
                'kicker' => 'Plans et packs',
                'headline' => 'Choisissez le plan ou le pack Smart TV adapte a votre besoin.',
                'description' => 'Les packs Smart TV sont disponibles en 3, 6 et 12 mois, tandis que SUP reste un plan separe sur 12 mois.',
            ],
            'es' => [
                'meta_title' => 'Planes y packs | Rifi Media',
                'meta_description' => 'Compara los packs Smart TV y el plan SUP con precios claros, instalacion guiada y seguimiento en Marruecos.',
                'kicker' => 'Planes y packs',
                'headline' => 'Elige el plan o pack Smart TV que mejor encaje con tu necesidad.',
                'description' => 'Los packs Smart TV estan disponibles en 3, 6 y 12 meses, mientras que SUP sigue como un plan separado de 12 meses.',
            ],
            'ar' => [
