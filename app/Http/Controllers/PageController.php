...
class PageController extends Controller
{
    ...
    protected function packagesPage(): array
    {
        return $this->localized([
            'en' => [
                'meta_title' => 'Support plans | Rifi Media',
                'meta_description' => 'Compare Basic, Advanced, and Premium support plans for device setup, app guidance, troubleshooting, and follow-up support in Morocco.',
                'kicker' => 'Support plans',
                'headline' => 'Choose the support plan that fits your setup and follow-up needs.',
                'description' => 'Each plan is framed around technical help, response priority, device scope, and follow-up level.',
            ],
            'fr' => [
                'meta_title' => 'Plans de support | Rifi Media',
                'meta_description' => 'Comparez les plans Basic, Advanced et Premium pour la configuration, l aide applicative, le depannage et le suivi au Maroc.',
                'kicker' => 'Plans de support',
                'headline' => 'Choisissez le plan de support adapte a votre besoin de configuration et de suivi.',
                'description' => 'Chaque plan est presente autour de l aide technique, de la priorite de reponse, du nombre d appareils et du suivi.',
            ],
            'es' => [
                'meta_title' => 'Planes de soporte | Rifi Media',
                'meta_description' => 'Compara los planes Basic, Advanced y Premium para configuracion, ayuda con apps, solucion tecnica y seguimiento en Marruecos.',
                'kicker' => 'Planes de soporte',
                'headline' => 'Elige el plan de soporte que mejor encaje con tu configuracion y seguimiento.',
                'description' => 'Cada plan se presenta segun ayuda tecnica, prioridad de respuesta, alcance por dispositivo y seguimiento.',
            ],
            'ar' => [
