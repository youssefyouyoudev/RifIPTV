...
return [
    ...
    'common' => [
        ...
        'contact_title' => 'Need clarification?',
        'contact_body' => 'If you need help understanding a policy, use the support area or contact your assigned admin before placing or renewing an order.',
        'related_title' => 'Related policies',
        'cta' => 'Talk to support',
    ],
    'pages' => [
        'privacy' => [
            ...
            'sections' => [
                ...
                [
                    'title' => 'Storage, access, and retention',
                    'body' => 'We keep account and transaction information only for as long as it is reasonably necessary for service delivery, legal obligations, fraud prevention, and support continuity.',
                    'items' => [
                        'Access to account records is limited to authorized staff and assigned administrators.',
                        'Payment confirmations are stored, but sensitive card data should remain with the payment processor when applicable.',
                        'Support records may be retained to resolve recurring technical or billing issues.',
                        'When deletion is legally and operationally possible, account records can be removed or anonymized.',
                    ],
                ],
                [
                    'title' => 'Your privacy choices',
                    'body' => 'You can request account corrections, update personal details, or ask questions about how your information is used.',
                    'items' => [
                        'Update your name, email address, and password from the account area when available.',
                        'Contact support if you want to review, correct, or remove inaccurate information.',
                        'Ask for clarification before sharing sensitive data in support conversations.',
                    ],
                ],
            ],
        ],
        'terms' => [
            ...
            'sections' => [
                ...
                [
                    ...
                    'body' => 'Accounts may be restricted or closed when necessary to protect the service, clients, or operational integrity.',
                    'items' => [
                        'We may suspend access in cases of fraud, chargebacks, abusive conduct, or serious policy violations.',
                        'Repeated misuse of support, payment manipulation, or attempts to bypass platform rules can lead to termination.',
                        'Termination does not automatically create a refund right when policy violations are involved.',
                    ],
                ],
            ],
        ],
        'security' => [
            ...
            'sections' => [
                [
                    ...
                    'body' => 'We design the website and account area to reduce confusion, lower abuse risk, and support secure access.',
                    'items' => [
                        'Protected login flows, verified account actions, and session-based authentication.',
                        'Role separation between clients and administrators to reduce data exposure.',
                        'Clear status indicators, payment history visibility, and support ownership for better trust.',
                    ],
                ],
                [
                    'title' => 'Payment safety',
                    'body' => 'We aim to keep payment handling clear and minimize direct exposure to sensitive data on the website itself.',
                    'items' => [
                        'Payment references, transaction status, and renewal history are tracked for support and auditing.',
                        'Sensitive processor-side payment data should remain with the payment provider when external processors are used.',
                        'Orders may be reviewed if payment details look inconsistent, incomplete, or suspicious.',
                    ],
                ],
                [
                    'title' => 'Support safety practices',
                    'body' => 'Support interactions should remain professional, limited to what is necessary, and traceable when possible.',
                    'items' => [
                        'Clients should avoid sending unnecessary sensitive information in support messages.',
                        'Support should confirm order identifiers, account details, or transaction references before high-impact changes.',
                        'Assigned admins help keep ownership clear and reduce confusion around renewals and issue handling.',
                    ],
                ],
                [
        ...
        'refund' => [
            ...
            'sections' => [
                ...
                [
                    ...
                    'body' => 'Our team reviews the request, checks service records, and replies with the next step or final outcome.',
                    'items' => [
                        'Support may ask for additional details before a final decision is made.',
                        'If a refund is approved, timing depends on the payment method and provider workflow.',
                        'Clients should contact support before filing a chargeback whenever possible so the issue can be reviewed fairly.',
                    ],
                ],
            ],
        ],
        'cookies' => [
            ...
            'sections' => [
                [
                    ...
                    'body' => 'Cookies and local storage help the website function correctly and remember useful preferences.',
                    'items' => [
                        'Keep users signed in to protected areas when authentication is active.',
                        'Remember language and theme preferences between visits.',
                        'Support basic security, session continuity, and account-related workflows.',
                    ],
                ],
                [
                    'title' => 'Types of storage in use',
                    'body' => 'The website may use a mix of session cookies, preference cookies, and browser storage depending on the feature.',
                    'items' => [
                        'Session cookies for authentication and request protection.',
                        'Preference storage for light mode, dark mode, and locale behavior.',
                        'Operational cookies or temporary storage for secure form submissions and navigation continuity.',
                    ],
                ],
                [
                    'title' => 'Managing your preferences',
                    'body' => 'You can control many browser-level storage settings directly in your browser configuration.',
                    'items' => [
                        'Deleting cookies may sign you out or reset language and theme choices.',
                        'Blocking essential storage may affect login, support forms, and dashboard functionality.',
                        'Browser settings differ, so check your browser help center for exact controls.',
                    ],
                ],
            ],
        ],
