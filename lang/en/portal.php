...
return [
    ...
    'auth' => [
        ...
        'register' => [
            ...
            'note' => 'Every new signup is registered as a client. Admin accounts stay reserved for management, revenue tracking, and service operations.',
    ...
    'profile' => [
        ...
        'sections' => [
            'profile' => [
                ...
                'description' => 'Update the name and email used for your package and support communication.',
    ...
    'dashboard' => [
        'admin' => [
            ...
            'description' => 'Track every client, active package, payment, and support owner from one role-aware dashboard.',
            ...
            'metrics' => [
                ...
                'active_subscriptions' => 'Active packages',
                'active_subscriptions_meta' => 'Current service periods still active across your client base.',
            ...
            'flow' => [
                ...
                'items' => [
                    ...
                    [
                        'title' => 'Packages stay visible and measurable',
                        'text' => 'You can read status, expiry timing, package choice, and transaction value in one place.',
                    ],
                    [
            ...
            'subscriptions' => [
                ...
                'total' => ':count records',
                'empty' => 'No service packages available.',
                'columns' => [
                    'client' => 'Client',
                    'plan' => 'Plan',
                    'expires' => 'Expires',
        ...
        'client' => [
            ...
            'waiting_text' => 'Your service package will appear here as soon as the admin activates your service.',
