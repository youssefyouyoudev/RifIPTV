            ...
            <header class="app-header">
                <div class="container-xxl px-3 px-md-4 px-lg-5">
                    <div class="header-shell px-3 px-md-4 py-3" data-header-shell>
                        <div class="d-flex align-items-center justify-content-between gap-3">
                            ...
                            <nav class="d-none d-lg-flex align-items-center gap-4">
                                ...
                                <a href="{{ route('home') }}#features" class="nav-link-rif">{{ data_get($nav, 'features', 'Features') }}</a>
                                <a href="{{ route('home') }}#plans" class="nav-link-rif">{{ data_get($nav, 'pricing', 'Pricing') }}</a>
                                <a href="{{ route('home') }}#support" class="nav-link-rif">{{ data_get($nav, 'support', 'Support') }}</a>
                                <a href="{{ route('legal.index') }}" class="nav-link-rif">{{ trans('legal.hub.kicker') }}</a>
                            </nav>
                                    ...
                                    <div class="dropdown">
                                        <button class="user-menu-toggle dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                            ...
                                            <span class="user-menu-copy">
                                                ...
                                                <span class="user-menu-role">{{ $authUser->isAdmin() ? __('workflow.admin.eyebrow') : __('workflow.client.eyebrow') }}</span>
                                            </span>
                                        </button>
                                        <div class="dropdown-menu dropdown-menu-end user-menu-dropdown">
                                            ...
                                            @if (! $authUser->isAdmin())
                                                <a href="{{ route('onboarding.show') }}" class="dropdown-item user-menu-item">
                                                    <i data-lucide="credit-card" class="icon-sm"></i>
                                                    <span>{{ __('workflow.client.setup.manage_order') }}</span>
                                                </a>
                                            @endif
                    ...
                    <div class="header-shell mobile-menu d-xl-none" data-mobile-menu>
                        ...
                        <a href="{{ route('home') }}#features">{{ data_get($nav, 'features', 'Features') }}</a>
                        <a href="{{ route('home') }}#plans">{{ data_get($nav, 'pricing', 'Pricing') }}</a>
                        <a href="{{ route('home') }}#support">{{ data_get($nav, 'support', 'Support') }}</a>
                        <a href="{{ route('legal.index') }}">{{ trans('legal.hub.kicker') }}</a>
                        @auth
                            ...
                            @if (! $authUser->isAdmin())
                                <a href="{{ route('onboarding.show') }}">{{ __('workflow.client.setup.manage_order') }}</a>
                            @endif
                        ...
                        <div class="d-flex flex-column flex-sm-row gap-3 mt-3">
                            @guest
                                <a href="{{ route('register') }}" class="btn-rif-secondary justify-content-center w-100">{{ data_get($nav, 'sign_up', 'Sign up') }}</a>
                            @else
